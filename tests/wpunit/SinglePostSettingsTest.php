...
class SinglePostTest extends \Codeception\TestCase\WPTestCase
{
    ...
    public function convert_to_integer()
    {
        ...
        $defaults = array(
            'apply_global_settings' => array(
                'post_author_review_settings' => array(
                    'can_show_the_author_review' => 'apply_global_settings',
                    'custom_location' => 0,
                    'location' => 'after',
                ),
                'post_user_review_settings' => array(
                    'can_show_the_user_review' => 'apply_global_settings',
                    'custom_location' => 0,
                    'location' => 'after',
                ),
            ),
            'dont_show' => array(
                'post_author_review_settings' => array(
                    'can_show_the_author_review' => 'dont_show',
                ),
                'post_user_review_settings' => array(
                    'can_show_the_user_review' => 'dont_show',
                ),
            ),
            'show_author_reviews_only' => array(
                'post_author_review_settings' => array(
                    'can_show_the_author_review' => 'show',
                    'custom_location' => 0,
                    'location' => 'after',
                ),
                'post_user_review_settings' => array(
